...
<div class="card">
  ...
  <div class="card-body fs--1 p-4 position-relative">
    ...
    <div class="row">
      ...
      <div class="col">
        <!-- Make Combo -->
        <label class="form-label" for="branch">Benefits*</label>
      ...
      <div class="modal-body p-0">
        ...
        <div class="p-4">
          ...
          <form id="add_bf_frm" name="add_bf_frm">
            <div class="p2">
              <label for="modal_benefit_name" class="form-label">Benefit Name*</label>
...
<script>
  ...
  $(document).ready(function() {
    $('#add_bf_submit').click(function(e) {
      ...
      if (cat_name == '') {
        ...
        var conf = confirm("Do You Want to Add a New Benefit?")
        if (conf) {
          $.ajax({
            ...
            success: function(data) {
              $('#add_bf_frm')[0].reset();
              //$('form').trigger("reset");
              if (data == 'New Benefit Added Successfully') {
                updateComboBoxes();
              }
              alert(data)
            }
  ...
  fetch('../payroll/load_benefits.php')
  ...
  function updateBranchSelect() {
    ...
    opt.appendChild(document.createTextNode("-- Select Benefits --"));
