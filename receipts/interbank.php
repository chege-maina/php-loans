  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col">
          <label for="customer" class="form-label">Select Bank From</label>
          <select class="form-select" id="customer" required>
          </select>
        </div>

        <div class="col">
          <label for="bank" class="form-label">Select Bank To</label>
...
<script>
  window.addEventListener('DOMContentLoaded', (event) => {
    initSelectElement("#customer", "-- Select Bank --");
    populateSelectElement("#customer", "../includes/load_bank.php", "name");
  ...
  function submitForm() {
    ...
    fetch('../includes/add_transfer.php', {
        method: 'POST',
        body: formData
      })
